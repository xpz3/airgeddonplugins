...
function initialize_nogui_language_strings() {
	...
	arr["RUSSIAN","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	arr["GREEK","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	arr["ITALIAN","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	arr["POLISH","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	arr["GERMAN","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	arr["TURKISH","nogui_text_1"]="The attack is going to start. Press Ctrl+C to stop the attack and return to menu. Press Enter to continue..."
	...
	arr["RUSSIAN","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["GREEK","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["ITALIAN","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["POLISH","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["GERMAN","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["TURKISH","nogui_text_2"]="Press Ctrl+C to return to the menu..."
	arr["ARABIC","nogui_text_2"]="Press Ctrl+C to return to the menu..."
}
